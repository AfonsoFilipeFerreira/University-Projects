...
<head>
    ...
    <link rel="stylesheet" href="homeloged.css">
...
<main class="main-content">
    ...
    <p> Our site intents for the user to share memories and experiences made during their travels. Share with the
        other users pictures of places you have been to, what did you do there, and if you would like to come back
            ...
            <div class="publication">
                ...
                <div class="publication-content">
                    ...
                    <div class="pub-interactions">
                        <?php if ($userLiked): ?>
                            <form action="unlike.php?username=<?php echo $username; ?>" method="POST">
                        ...
                        <?php else: ?>
                            <form action="like.php?username=<?php echo $username; ?>" method="POST">
                                <input type="hidden" name="username" value="<?php echo $username; ?>">
                                <input type="hidden" name="publication_id" value="<?php echo $row['id']; ?>">
                    ...
                    <div class="comments-session">
                        <div>
                            <form action="add_comment.php?username=<?php echo $username; ?>" method="POST"
                                class="comment-form">
                                <input type="hidden" name="publication_id" value="<?php echo $row['id']; ?>">
                    ...
                    <?php if ($username === $row['username']): ?>
                        <form action="delete_pub.php" method="POST" class="delete-publication-form">
                            <input type="hidden" name="username" value="<?php echo $username; ?>">
                            <input type="hidden" name="publication_id" value="<?php echo $row['id']; ?>">
